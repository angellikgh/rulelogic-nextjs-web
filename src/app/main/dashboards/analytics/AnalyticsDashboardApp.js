...
const VisitorsOverviewWidget = dynamic(
  () => import('./widgets/VisitorsOverviewWidget'),
  { ssr: false }
);
const ConversionsWidget = dynamic(() => import('./widgets/ConversionsWidget'), {
  ssr: false,
});
const ImpressionsWidget = dynamic(() => import('./widgets/ImpressionsWidget'), {
  ssr: false,
});
const VisitsWidget = dynamic(() => import('./widgets/VisitsWidget'), {
  ssr: false,
});
const VisitorsVsPageViewsWidget = dynamic(
  () => import('./widgets/VisitorsVsPageViewsWidget'),
  {
    ssr: false,
  }
);
