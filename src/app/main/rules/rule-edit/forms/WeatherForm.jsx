...
function WeatherForm({ formRef, rule }) {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      weather: rule.weathertext || constants.weatherTextList[0],
      temperatureUnit: rule.temperatureunit || 0,
      fromTemperature: rule.temperaturefrom || 0,
      toTemperature: rule.temperatureto || 0,
    ...
    onSubmit: (values) => {
      ...
      setLoading(true);
      RuleService.saveWeatherRule(values)
        .then((res) => {
