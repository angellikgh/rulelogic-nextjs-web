...
function ShardPriceForm({ formRef, rule, error, onNotify }) {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      stockExchange: rule.stockExchange || '',
      shareSymbol: rule.shareSymbol || '',
      sharePrice: rule.sharePrice || '',
      priceFrom: rule.priceFrom || '',
      priceTo: rule.priceTo || '',
