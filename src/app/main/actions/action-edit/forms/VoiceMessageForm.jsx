...
function EmailForm({ formRef, action, error }) {
  ...
  const validationSchema = yup.object({
    ...
    from: yup.string('Enter the sender').required('This is required'),
    to: yup.string('Enter the receiver').required('This is required'),
  ...
  const formik = useFormik({
    initialValues: {
      title: action.voicemessagetitle || '',
      description: action.voicemessage || '',
      from: action.voicemessagefrom || '',
      to: action.voicemessageto || '',
